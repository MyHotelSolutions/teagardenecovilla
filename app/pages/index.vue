<template>
    <video 
        src="https://ik.imagekit.io/myHotelSolutions/TeaGardenEcovillas/Video/tea%20garden%20eco%20villa.mp4?updatedAt=1768236891386"
        autoplay
        muted
        playsinline
        loop
        class="relative h-screen w-full object-cover z-0"
    >
    </video>
    <Menubar class="absolute top-0 left-0 right-0 z-40"></Menubar>
    <!-- Content Overlay -->
    ...
    <div class="flex flex-col justify-center gap-8 sm:gap-16 md:gap-20 lg:gap-25 min-h-[75vh] h-auto bg-[#fafaf9] py-8 sm:py-0">
        <div class="flex flex-col justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-20 h-auto sm:min-h-[86vh] w-full mx-auto px-4 sm:px-0">
            ...
            <div class="flex flex-col justify-center items-center gap-4 text-center">
                ...
                <p class="text-sm sm:text-base font-light leading-relaxed text-gray-700 overflow-y-auto max-w-lg text-center">Key services we provide: Private pool, in-house chef, A/C rooms, hot water, and thoughtful amenities for relaxation in a paradise setting</p>
            </div>
